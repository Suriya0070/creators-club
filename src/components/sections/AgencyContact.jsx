    ...
    <section id="contact" className="py-24 bg-[#1C1A2E]">
      <div className="max-w-[1400px] mx-auto px-6 sm:px-10">
        ...
        <AnimatedSection className="mb-14">
          <p className="badge-cyan mb-5" style={{ color: '#F5A623' }}>Get Started</p>
          ...
          <p className="text-white/40 mt-5 text-sm max-w-md leading-relaxed">
            Fill in the brief below and we'll get back to you within one business day with a tailored proposal.
          </p>
        </AnimatedSection>
        ...
        <div className="grid lg:grid-cols-[1fr_2fr] gap-16">
          ...
          <AnimatedSection className="space-y-8">
            {[
              { icon: Mail, label: 'Email', value: 'hello@prminds.in', href: 'mailto:hello@prminds.in' },
              { icon: MessageSquare, label: 'WhatsApp', value: '+91 98765 43210', sub: 'Mon–Sat, 10am–7pm IST', href: 'https://wa.me/919876543210' },
          ...
          <AnimatedSection delay={0.15}>
            {status === 'sent' ? (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="py-20 text-center">
                ...
                <h3 className="section-heading text-3xl text-white mb-3">Brief Received.</h3>
                <p className="text-white/40 text-sm max-w-sm mx-auto">We'll respond within one business day with a tailored proposal.</p>
              </motion.div>
            ) : (
              <form onSubmit={(e) => { e.preventDefault(); setStatus('sent') }} className="space-y-5">
                ...
                <div className="pt-2 flex items-center gap-4 flex-wrap">
                  <button type="submit" className="btn-primary">
                    Send Project Brief <ArrowUpRight className="w-4 h-4" />
                  </button>
                  <p className="text-white/25 text-xs">No commitment required · 1 business day response</p>
                </div>
              </form>
            )}
          </AnimatedSection>
